...
async function wrapHandler(handler: () => Promise<Response>): Promise<Response> {
    try {
...
export function getHandler<Params>(handler: (p: Params) => Promise<Response>): (req: Request, { params }: { params: Promise<Params> }) => Promise<Response> {
